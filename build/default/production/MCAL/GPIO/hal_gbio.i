...
# 1 "MCAL/GPIO/hal_gbio.h" 1
# 12 "MCAL/GPIO/hal_gbio.h"
# 1 "MCAL/GPIO/../device_config.h" 1
# 13 "MCAL/GPIO/hal_gbio.h" 2
...
# 14 "MCAL/GPIO/hal_gbio.h" 2
# 1 "MCAL/GPIO/hal_gbio_config.h" 1
# 15 "MCAL/GPIO/hal_gbio.h" 2
# 33 "MCAL/GPIO/hal_gbio.h"
typedef enum {
    GPIO_LOW,
    GPIO_HIGH
} logic_t;
...
Std_ReturnType gbio_pin_init(const pin_config_t * pin_config) {
    ...
    if ((pin_config == ((void*)0)) || (pin_config->pin > (8 - 1)) || (pin_config->pin > (5 - 1))) {
        return ret;
    } else {
...
Std_ReturnType gbio_pin_get_direction(const pin_config_t * pin_config, uint8 *direction) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if ((pin_config == ((void*)0)) || (direction == ((void*)0)) || (pin_config->pin > (8 - 1)) || (pin_config->port > (5 - 1))) {
        return ret;
    } else {
        *direction = ((*tris_registers[pin_config->port] >> pin_config->pin) & (uint8)1);
        ret = (Std_ReturnType)0x01;
    }
    return ret;
}
...
Std_ReturnType gbio_pin_read_logic(const pin_config_t * pin_config, uint8 *logic) {
    Std_ReturnType ret = (Std_ReturnType)0x00;
    if ((pin_config == ((void*)0)) || (logic == ((void*)0)) || (pin_config->pin > (8 - 1)) || (pin_config->pin > (5 - 1))) {
        return ret;
    } else {
